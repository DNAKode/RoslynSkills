...
public static class DefaultRegistryFactory
{
    public static ICommandRegistry Create()
    {
        IAgentCommand[] commands =
        {
            ...
            new ReplaceInMemberCommand(),
            new InsertTextCommand(),
            new BatchExactEditCommand(),
            new EditTransactionCommand(),
            new EditClaimCommand(),
            new ProposeFromDiagnosticsCommand(),
            new ApplyRepairPlanCommand(),
            new WorkspacePreloadCommand(),
            new WorkspaceStatusCommand(),
            new WorkspaceRefreshCommand(),
            new WorkspaceCloseCommand(),
            new WorkspaceListCommand(),
